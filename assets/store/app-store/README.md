...
Automatic Weather & Location Context: Context is everything. When you create a new setup, the app automatically fetches the current weather, temperature, and location.
...
Your Data, Your Ownership: Your settings are stored locally. We have zero access to your data.
...
- Racers & Mechanics: Maintain a professional-grade log of race-day tunes and baseline settings.
...
## Keywords
```
MTB, cycling, suspension, tuning, logbook, bicycle, setup, tracker, road, gravel, downhill, enduro
```
